...
namespace Assistant
{
  public partial class MainForm
  {
    ...
    private void agentList_SelectedIndexChanged(object sender, System.EventArgs e)
    {
      try
      {
        Agent.Select(agentList.SelectedIndex, agentList, agentSubList, agentGroup, agentB1, agentB2, agentB3,
            agentB4, agentB5, agentB6, agentB7);
    ...
    private void agentB7_Click(object sender, System.EventArgs e)
    {
      Agent_Button(7);
    }
    ...
    private void playScript_Click(object sender, EventArgs e)
    {
      ...
      ScriptManager.PlayScriptFromUI(scriptEditor.Lines.ToArray(), selectedScript != null ? selectedScript.ToString() : "N/A", Config.GetBool("EnableHighlight"));
    }
